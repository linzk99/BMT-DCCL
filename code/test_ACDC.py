...
parser.add_argument('--model2', type=str, default='UNet_BMT_DCCL', help='model_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "../model/ACDC/{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    test_save_path = "../model/ACDC/{}_{}_labeled/predictions/".format(FLAGS.exp, FLAGS.labelnum)
    ...
    net1.load_state_dict(torch.load(save_model_path1))
    print("net1 init weight from {}".format(save_model_path1))
    net1.eval()

    net2.load_state_dict(torch.load(save_model_path2))
...
if __name__ == '__main__':
    ...
    with open(test_save_path+'../avg_model_performance.txt', 'w') as f:
